...
if (isset($_GET['delID'])) {
    ...
    $sql = "DELETE FROM seller WHERE seller_id=$sid";
              ...
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <tbody>
                  <tr>
                    <td><?php echo $i;?>.</td>
                    <td>
                        <img src="<?php echo $rows['seller_img'];
                         ?>" style= "width:50px; height:50px;" />
                      
                    </td>
                    <td><?php echo $rows['seller_id'];?></td>
                    <td class="tm-catShop-name" ><?php echo $rows['seller_name'];?></td>
                    <td><?php echo $rows['seller_cat'];?></td>
                    <td>
                      <a href="edit_shopList.php?sid=<?php echo $rows['seller_id']; ?>" class="tm-product-edit-link">
                        <i class="far fa-edit tm-product-edit-icon"></i>
                      </a>
                    </td>
                    <td>
                      <a href="seller_list.php?delID=<?php echo $rows['seller_id'];?>" class="tm-product-delete-link" onclick="return confirm('Confirm to remove this seller?')">
